...
- **All other platforms:** MIT License. See [`LICENSE-MIT`](LICENSE-MIT).

This is a platform-specific licensing policy, not a choice between two licenses for a given
release. Third-party components remain subject to their respective licenses; see
