...
- The first-run telemetry choice, PostHog/Cloudflare processors, pseudonymous identifiers, derived
  country, five-minute batching, idle behavior, and the reset/deletion workflow.
